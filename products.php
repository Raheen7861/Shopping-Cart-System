        ...
        <div>
            ...
            <div class="container">
                <div class="jumbotron">
                    ...
                    <p>We have the best product, chicken and mutton , fruits for you. No need to hunt around, we have all in one place.</p>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/sony_dslr.jpeg" alt="Cannon">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cannon EOS</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/benjamin-lehman-OK7_3OlMCB4-unsplash.jpg" alt="Titan 301">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/c-d-x-PDX_a_82obo-unsplash.jpg" alt="Titan 201">
                            </a>
                            <center>
                                <div class="caption">
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/daniel-romero-6V5vTuoeCZg-unsplash.jpg" alt="htm milan">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Ear buds</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/gary-meulemans-PvIvL20StFM-unsplash.jpg" alt="Favre Leuba">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Ear plug</h3>
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/aheart-MYCoMHyNtiE-unsplash.jpg" alt="Raymond shirt"  width="140">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Realmi</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pexels-jess-bailey-designs-788946.jpg" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>iphone 8</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/shiwa-id-Uae7ouMw91A-unsplash.jpg" alt="HXR" width="110" height="">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>VIVo</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/zana-latif-MPq-1IxX1nU-unsplash.jpg" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>xiaomia</h3>
            ...
            <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/olia-nayda-DkaEkeK81KU-unsplash.jpg" alt="Raymond shirt" width="140">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Hp</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/dmitry-rodionov-PjCQ5-4OwaI-unsplash.jpg" alt="Charles shirt">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>huawei</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/erick-cerritos-i5UV2HpITYA-unsplash.jpg" alt="HXR" >
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Dell</h3>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/pexels-alex-leonardo-10170363.jpg" alt="PINK">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Mac</h3>
